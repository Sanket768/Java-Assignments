class amu {
        ...
        public static void main(String[] args) {
            ...
            System.out.println("Memory usage before array creation: " + memoryBefore);
            ...
            System.out.println("Memory usage after array creation: " + memoryAfterCreation);

            array = resizeArray(array, 20000);
            long memoryAfterAdd = runtime.totalMemory() - runtime.freeMemory();
            System.out.println("Memory after adding item: " + memoryAfterAdd);
    
            array = resizeArray(array, 500000);
